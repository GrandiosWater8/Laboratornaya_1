...
```bash
$ export GITHUB_USERNAME=GrandiosWater8                         # Создание переменной окружения GITHUB_USERNAME
$ export GIST_TOKEN=yyyyyyyyyyyyyyyyyyy                         # Создание переменной окружения GIST_TOKEN
